...
`exemplos_cli`geracao de md com testes de copia e cola para facilitar testes;![alt text](image.png)

**Modificacoes realizadas:** Alguns pequenos ajustes simples de formatacao e organizacao das linhas geradas.
**Link da conversa ou registro equivalente:** ![alt text](image-1.png)
